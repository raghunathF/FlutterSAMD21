...
#define LEDMATRIX_READ_DATA_LENGTH				0x04
#define LEDMATRIX_WRITE_DATA_LENGTH_1			0x37
...
void  checkSetOutputs()
{
	...
	static uint8_t testWriteDataI2C[55] = {0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,
